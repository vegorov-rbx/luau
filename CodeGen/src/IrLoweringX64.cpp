...
void IrLoweringX64::lowerInst(IrInst& inst, uint32_t index, const IrBlock& next)
{
    ...
    case IrCmd::CHECK_BUFFER_LEN:
    {
        ...
        else if(inst.b.kind == IrOpKind::Constant)
        {
            ...
            if(offset < 0 || unsigned(offset) + unsigned(size) >= unsigned(INT_MAX))
                ...
                build.cmp(dword[regOp(inst.a) + offsetof(Buffer, len)], offset + size);
    ...
    case IrCmd::BUFFER_READI8:
    {
        ...
        if(inst.b.kind == IrOpKind::Inst)
            build.movsx(inst.regX64, byte[regOp(inst.a) + qwordReg(regOp(inst.b)) + offsetof(Buffer, data)]);
        else
            build.movsx(inst.regX64, byte[regOp(inst.a) + intOp(inst.b) + offsetof(Buffer, data)]);
        break;
    }
    ...
    case IrCmd::BUFFER_READU8:
    {
        ...
        if(inst.b.kind == IrOpKind::Inst)
            build.movzx(inst.regX64, byte[regOp(inst.a) + qwordReg(regOp(inst.b)) + offsetof(Buffer, data)]);
        else
            build.movzx(inst.regX64, byte[regOp(inst.a) + intOp(inst.b) + offsetof(Buffer, data)]);
        break;
    }
    ...
    case IrCmd::BUFFER_WRITEI8:
    {
        ...
        if (inst.b.kind == IrOpKind::Inst)
            build.mov(byte[regOp(inst.a) + qwordReg(regOp(inst.b)) + offsetof(Buffer, data)], value);
        else
            build.mov(byte[regOp(inst.a) + intOp(inst.b) + offsetof(Buffer, data)], value);
        break;
    }
    ...
    case IrCmd::BUFFER_READI32:
    {
        ...
        if(inst.b.kind == IrOpKind::Inst)
            build.mov(inst.regX64, dword[regOp(inst.a) + qwordReg(regOp(inst.b)) + offsetof(Buffer, data)]);
        else
            build.mov(inst.regX64, dword[regOp(inst.a) + intOp(inst.b) + offsetof(Buffer, data)]);
        break;
    }
    ...
    case IrCmd::BUFFER_WRITEI32:
    {
        ...
        if(inst.b.kind == IrOpKind::Inst)
            build.mov(dword[regOp(inst.a) + qwordReg(regOp(inst.b)) + offsetof(Buffer, data)], value);
        else
            build.mov(dword[regOp(inst.a) + intOp(inst.b) + offsetof(Buffer, data)], value);
        break;
    }
    ...
    case IrCmd::BUFFER_READF32:
    {
        ...
        if(inst.b.kind == IrOpKind::Inst)
            build.vcvtss2sd(inst.regX64, inst.regX64, dword[regOp(inst.a) + qwordReg(regOp(inst.b)) + offsetof(Buffer, data)]);
        else
            build.vcvtss2sd(inst.regX64, inst.regX64, dword[regOp(inst.a) + intOp(inst.b) + offsetof(Buffer, data)]);
        break;
    }
    ...
    {
        if(inst.b.kind == IrOpKind::Inst)
            storeDoubleAsFloat(dword[regOp(inst.a) + qwordReg(regOp(inst.b)) + offsetof(Buffer, data)], inst.c);
        else
            storeDoubleAsFloat(dword[regOp(inst.a) + intOp(inst.b) + offsetof(Buffer, data)], inst.c);
        break;
    }
    ...
    case IrCmd::BUFFER_READF64:
    {
        ...
        if(inst.b.kind == IrOpKind::Inst)
            build.vmovsd(inst.regX64, qword[regOp(inst.a) + qwordReg(regOp(inst.b)) + offsetof(Buffer, data)]);
        else
            build.vmovsd(inst.regX64, qword[regOp(inst.a) + intOp(inst.b) + offsetof(Buffer, data)]);
        break;
    }
    ...
    case IrCmd::BUFFER_WRITEF64:
    {
        ...
        if(inst.b.kind == IrOpKind::Inst)
            target = qword[regOp(inst.a) + qwordReg(regOp(inst.b)) + offsetof(Buffer, data)];
        else
            target = qword[regOp(inst.a) + intOp(inst.b) + offsetof(Buffer, data)];
